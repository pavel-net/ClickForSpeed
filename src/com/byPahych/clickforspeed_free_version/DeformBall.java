...
public class DeformBall extends Ball {

	public DeformBall(float pX, float pY,
	...
	public void StartAnimation()
	{
		...
		this.animate(new long[] {100, 70, 70, 70, 70, 70, 100}, new int[] {1, 2, 3, 4, 5, 6, 7}, 0, new IAnimationListener() {
